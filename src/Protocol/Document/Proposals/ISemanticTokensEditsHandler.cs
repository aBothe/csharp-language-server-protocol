...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document.Proposals
{
    ...
    public static class SemanticTokensExtensions
    {
        ...
        public static Task<SemanticTokens> RequestSemanticTokens(this ITextDocumentLanguageClient mediator,
            SemanticTokensParams @params, CancellationToken cancellationToken)
        {
            return mediator.SendRequest(@params, cancellationToken);
        }

        public static Task<SemanticTokensOrSemanticTokensEdits> RequestSemanticTokensEdits(
            this ITextDocumentLanguageClient mediator, SemanticTokensEditsParams @params, CancellationToken cancellationToken)
        {
            return mediator.SendRequest(@params, cancellationToken);
        }

        public static Task<SemanticTokens> RequestSemanticTokensRange(this ITextDocumentLanguageClient mediator,
