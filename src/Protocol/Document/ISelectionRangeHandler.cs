...
namespace OmniSharp.Extensions.LanguageServer.Server
{
    ...
    public static class SelectionRangeExtensions
    {
        ...
        public static Task<Container<SelectionRange>> RequestSelectionRange(this ITextDocumentLanguageClient mediator, SelectionRangeParams @params, CancellationToken cancellationToken = default)
        {
