...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class CodeActionExtensions
    {
        ...
        public static Task<CommandOrCodeActionContainer> RequestCodeAction(this ITextDocumentLanguageClient mediator, CodeActionParams @params, CancellationToken cancellationToken = default)
        {
