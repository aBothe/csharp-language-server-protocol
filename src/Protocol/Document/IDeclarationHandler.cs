...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class DeclarationExtensions
    {
        ...
        public static Task<LocationOrLocationLinks> RequestDeclaration(this ITextDocumentLanguageClient mediator, DeclarationParams @params, CancellationToken cancellationToken = default)
        {
