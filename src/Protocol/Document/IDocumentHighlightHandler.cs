...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class DocumentHighlightExtensions
    {
        ...
        public static Task<DocumentHighlightContainer> RequestDocumentHighlight(this ITextDocumentLanguageClient mediator, DocumentHighlightParams @params, CancellationToken cancellationToken = default)
        {
