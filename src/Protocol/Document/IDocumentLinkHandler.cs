...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class DocumentLinkExtensions
    {
        ...
        public static Task<DocumentLinkContainer> RequestDocumentLink(this ITextDocumentLanguageClient mediator, DocumentLinkParams @params, CancellationToken cancellationToken = default)
        {
