...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class DocumentColorExtensions
    {
        ...
        public static Task<Container<ColorPresentation>> RequestDocumentColor(this ITextDocumentLanguageClient mediator, DocumentColorParams @params, CancellationToken cancellationToken = default)
        {
