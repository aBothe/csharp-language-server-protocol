...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class TypeDefinitionExtensions
    {
        ...
        public static Task<LocationOrLocationLinks> RequestTypeDefinition(this ITextDocumentLanguageClient mediator, TypeDefinitionParams @params, CancellationToken cancellationToken = default)
        {
