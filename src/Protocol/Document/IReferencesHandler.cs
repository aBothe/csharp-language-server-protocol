...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Document
{
    ...
    public static class ReferencesExtensions
    {
        ...
        public static Task<LocationContainer> RequestReferences(this ITextDocumentLanguageClient mediator, ReferenceParams @params, CancellationToken cancellationToken = default)
        {
