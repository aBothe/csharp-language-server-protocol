...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Window
{
    ...
    public static class WorkDoneProgressCancelExtensions
    {
        ...
        public static void SendWorkDoneProgressCancel(this IWindowProgressLanguageClient mediator, IWorkDoneProgressParams @params)
        {
        ...
        public static void SendWorkDoneProgressCancel(this IWindowProgressLanguageClient mediator, ProgressToken token)
        {
            mediator.SendNotification(WindowNames.WorkDoneProgressCancel, new WorkDoneProgressCancelParams() {
                Token = token
            });
        ...
        public static void SendWorkDoneProgressCancel(this IWindowProgressLanguageClient mediator, WorkDoneProgressCancelParams token)
        {
