...
namespace OmniSharp.Extensions.LanguageServer.Protocol.Window
{
    ...
    public static class WorkDoneProgressCreateExtensions
    {
        ...
        public static async Task RequestWorkDoneProgressCreate(this IWindowProgressLanguageServer mediator, WorkDoneProgressCreateParams @params, CancellationToken cancellationToken = default)
        {
